// ==UserScript==
// @name         Daily RPH Calculator
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  try to take over the world!
// @author       Tyler Kimbell
// @match        https://www.bctoolbelt.com/users/{your-name}
...
const requestUrl = `https://www.bctoolbelt.com/users/{id}/timeline.json?start=${startTimestamp}&end=${endTimestamp}.999&interval=undefined`;
